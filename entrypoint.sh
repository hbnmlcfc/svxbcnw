...
UUID=${UUID:-'98cb305b-5abf-47c9-9e6c-d70845b66ff1'}
VMESS_WSPATH=${VMESS_WSPATH:-'/98cb305b-5abf-47c9-9e6c-d70845b66ff1-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/98cb305b-5abf-47c9-9e6c-d70845b66ff1-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/98cb305b-5abf-47c9-9e6c-d70845b66ff1-trojan'}
SS_WSPATH=${SS_WSPATH:-'/98cb305b-5abf-47c9-9e6c-d70845b66ff1-shadowsocks'}
